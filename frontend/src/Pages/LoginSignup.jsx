    ...
    <div className='loginsignup'>
      <div className="loginsignup-container">
        ...
        <div className="loginsignup-fields">
          ...
          <input name='email' value={fromData.email} onChange={changeHandler} type="email" placeholder='Email Adderss' />
        ...
        <div className="loginsignup-agree">
          ...
          <p>by continuing, i agree to the term of use & privancy policy</p>
        </div>
      </div>
